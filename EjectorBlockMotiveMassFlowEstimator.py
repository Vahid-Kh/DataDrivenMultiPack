...
from EjctrEstmtrMotiveMassFlowComparisson import mEjecBlock
...
for weeknum in [34]:
    ...
    suc_t_hp = df['T14 MT suction'].tolist()
    suc_t_le = [PSI('T', 'P', x, 'Q', 0, 'CO2') for x in suc_p]
