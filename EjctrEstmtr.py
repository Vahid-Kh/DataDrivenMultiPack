...
def mEjecEst(lstInp, ejctrSize, LabOnly):
    if LabOnly == False:
        ...
        fileName = r'C:\Users\U375297\OneDrive - Danfoss\Desktop\# Programming Projects\MultiPack\Ejector Data\LabDataOnly.xlsx'
    ...
    return (np.array(regressor2.predict(lstInp)) / np.array(regressor.predict(lstInp))).tolist()
...
hptest = [[90.00,10.00, 26.00,	-10.65,	30.00],  # #
          [90.00,10.00, 26.00,	-10.65,	35.00],  # #
          [90.00,10.00, 26.00,	-10.65,	40.00],  # #
          [90.00,10.00, 26.00,	-10.65,	30.00],
          [90.00,10.00, 26.00,	-10.65,	30.00],  # #
          [90.00,10.00, 26.00,	-10.65,	35.00],  # #
          [90.00,10.00, 26.00,	-10.65,	40.00],  # #
          [90.00,10.00, 26.00,	-10.65,	30.00],
...
print(mEjecBlock(hptest, 'Multi Ejector HP 3875', LabOnly=True))
