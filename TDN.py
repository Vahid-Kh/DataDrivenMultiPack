...
from CoolProp.CoolProp import Props as PRS
...
"""TEST Section"""
# print(TDN(100e5,3e5,0,0,0,'co2').t)
print(TDN(1e5,0,298,0,0,'co2').d)
print(TDN(1e5,0,298,0,0,'air').d)
# print(TDNex(100e5,3e5,0,0,0,'co2',300).exergy())
# print(PRS('C','T',300,'P',101.325,'MEG'))